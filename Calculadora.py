...
def init_window():
    ...
    tab_control.add(tab2, text='Salida')

    label = tk.Label(tab1, text='Calculadora', font=('Arial bold', 15))
    ...
    botonsalida = tk.Button(tab1,
                       text='CERRAR',
                       fg="black",
                       command=window.destroy)

    botonsalida.grid(column=1, row=6, pady = 5)

    label = tk.Label(tab2, text='Vuelva pronto', font=('Arial bold', 15))
    label.grid(column=0, row=0, pady=10)


    label_entrada1 = tk.Label(tab2, text='Espero haya encontrado util la calculadora ', font=('Arial bold', 10))
    label_entrada1.grid(column=0, row=1, pady=5)



    botonsalida = tk.Button(tab2,
                       text='CERRAR',
                       fg="black",
                       command=window.destroy)
    botonsalida.grid(column=0, row=2, pady=5)
